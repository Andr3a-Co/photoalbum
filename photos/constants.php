...
define('STUDENT_NAME', 'Andrea Espitia');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '103165504');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Wednesday 06:30PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'host-content-bucket');
...
define('DB_ENDPOINT', 'assigndatabase.cg3gy4kdpmcx.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance
define('DB_USERNAME', 'admin');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'lab-password');
...
define('DB_PHOTO_TITLE_COL_NAME', 'photoTittle');
...
define('DB_PHOTO_S3REFERENCE_COL_NAME', 'referenceObject');
